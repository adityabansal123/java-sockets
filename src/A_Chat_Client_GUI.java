...
public class A_Chat_Client_GUI {
    ...
    private static  JLabel L_Coversation = new JLabel();
    ...
    public static void Connect()
    {
        try {
            final int PORT = 8080;
            final String HOST = "radheradhe";
            Socket SOCK = new Socket(HOST, PORT);
            System.err.println("You are connected to: " + HOST);
    ...
    public static void ConfigureMainWindow()
    {
        ...
        L_Coversation.setHorizontalAlignment(SwingConstants.CENTER);
        L_Coversation.setText("Conversation");
        MainWindow.getContentPane().add(L_Coversation);
        L_Coversation.setBounds(100, 70, 140, 16);
        ...
        //String [] TestNames = {"Aditya", "Divyan", "Arnav", "Parag"};
        ...
        L_LoggedInAsBox.setFont(new java.awt.Font("Tahome", 0, 12));
